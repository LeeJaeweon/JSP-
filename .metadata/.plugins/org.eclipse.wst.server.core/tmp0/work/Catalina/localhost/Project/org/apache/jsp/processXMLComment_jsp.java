 ...
 * Generated at: 2023-10-12 14:53:14 UTC
...
public final class processXMLComment_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (xmlData != null && !xmlData.isEmpty()) {
    try {
        ...
        factory.setFeature("http://apache.org/xml/features/disallow-doctype-decl", false); // XXEë¥¼ íì©íê¸° ìí´ ì¤ì  ë³ê²½
        DocumentBuilder builder = factory.newDocumentBuilder();
        Document doc = builder.parse(new InputSource(new StringReader(xmlData)));
        
        String commentContent = doc.getElementsByTagName("comment").item(0).getTextContent();
        
        // ì¬ê¸°ìì ëê¸ ë´ì©ì ë°ì´í°ë² ì´ì¤ì ì ì¥íì­ìì¤.
